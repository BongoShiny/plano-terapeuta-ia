...
12. CAUSAS PROVÁVEIS — REGRA CRÍTICA: No campo "Causas Prováveis" dos dados acima estão listadas as ÚNICAS causas que podem ser mencionadas no plano. COPIE-AS EXATAMENTE como estão escritas. NUNCA adicione causas que NÃO estejam na lista. NUNCA substitua por sinônimos. Exemplos de ERROS GRAVES: se as causas dizem "Hérnia de Disco, Bruxismo", NUNCA escreva "postura no trabalho", "sedentarismo", "estresse", "acidente" ou qualquer outra causa que NÃO esteja explicitamente listada. Se as causas dizem "Estresse / Ansiedade", escreva exatamente "estresse e ansiedade" — nada mais.
