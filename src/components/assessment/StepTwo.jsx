...
- condicoes_preexistentes: array de strings, escolha APENAS entre: "Fibromialgia", "Artrose / Artrite", "Hérnia de Disco", "Diabetes", "Hipertensão", "Obesidade / Sobrepeso", "Lipedema", "Bruxismo", "Enxaqueca / Cefaleia crônica", "Osteoporose", "Doenças autoimunes", "Nenhuma"
          ...
          <div className="bg-white rounded-2xl p-6 max-w-sm mx-4 shadow-xl relative">
            ...
            <div className="space-y-3 text-sm" style={{ color: "#374151" }}>
              ...
              <div className="flex gap-2 items-start">
                ...
                <span>Entre na agenda do paciente novo e copie as informações que estaram em "Observações Gerais" Ao clicar no card.</span>
              </div>
              <div className="flex gap-2 items-start">
